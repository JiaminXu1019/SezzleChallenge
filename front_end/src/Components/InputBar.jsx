...
export default class InputBar extends Component {
    ...
    calculate = () => {
        ...
        try {
            ...
            this.setState({textInput:current_result});
    ...
    render() {
        return(
            ...
            <div className="input-group mb-3">
                <input type="text" className="form-control" id="calculationInput" value={this.state.textInput} onChange={this.handleChange} placeholder="Calculate Here"/>
